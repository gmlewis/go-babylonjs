...
// NewVRCameraMetrics returns a new VRCameraMetrics object.
//
// https://doc.babylonjs.com/api/classes/babylon.vrcamerametrics
func (b *Babylon) NewVRCameraMetrics(todo parameters) *VRCameraMetrics {
	p := b.ctx.Get("VRCameraMetrics").New(todo)
	return VRCameraMetricsFromJSObject(p)
}
