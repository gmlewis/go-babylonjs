...
// WebXREnterExitUIButtonArrayToJSArray returns a JavaScript Array for the wrapped array.
func WebXREnterExitUIButtonArrayToJSArray(array []*WebXREnterExitUIButton) []interface{} {
