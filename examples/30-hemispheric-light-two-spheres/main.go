// 30-hemispheric-light-two-spheres is a port to Go of the Babylon example located here:
...
func main() {
	...
	createScene := func() *babylon.Scene {
		...
		b.MeshBuilder().CreateSphere("sphere", nil, scene)

		sphere1 := b.MeshBuilder().CreateSphere("sphere1", nil, scene)
