// 19-transparent-background is a port to Go of the Babylon example located here:
// https://www.babylonjs-playground.com/#YDO1F#18
...
func main() {
	...
	createScene := func() *babylon.Scene {
		...
		camera := b.NewArcRotateCamera("Camera", 3*math.Pi/2, math.Pi/2, 5, b.Vector3().Zero(), scene, nil)
